...
; document.write(
    ...
    + br
    + br " 'characters can represent integers; just loop them as an OTP'
    ...
    + br + tab + format('(0.665m < Yoda) ∧ (Yoda < 0.667m)', 'i')
    ...
    + br
    + br + span('What languages support this?', {c: 'hover', t: 'All my languages will support logic chains and char∈{±,∓,+,−,×,÷,√,!,=,≠,<,>,≤,≥,∨,∧,∞,ℕ,ℤ,ℝ,..}'})
    + br + '-∞ < -a ≤ -b ≤ -c ≤ ∓0 ≤ +x ≤ +y ≤ +z < +∞'
    ...
    + br + 'uu=...'
    + br + 'uuu=o'
    + br + 'o=o∈{body,odd,auto}'
    + br + 'oo=au∈{aussie,auk,auto}'
    + br + 'ooo=a'
    + br + 'a=u∈hut'
    + br + 'aa=a∈apple'
    + br + 'aaa=e'
