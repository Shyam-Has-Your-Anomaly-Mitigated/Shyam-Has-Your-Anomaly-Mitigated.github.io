...
; document.write(
    ...
    + br + br + 'That\'s...'
    + br + tab + format('S', 'b') + 'hyam.'
    + br + tab + format('H', 'b') + 'as.'
    ...
    + br + '^Don\'t bother me if I become a ' + link('Ben, Dick, & Forelife', '/bdfl') + '; I will contact you. ;)'
    + br + br + 'LIVE LONG AND PROSPER \\V/,'
    + br + 'AGENT S.'
    + br + '🕴'
    + br + format('M', 'b') + 'igrating ' + format('I', 'b') + 'nfestive ' + format('B', 'b') + 'ugs ' + format('!', 'b') + '!'
)
